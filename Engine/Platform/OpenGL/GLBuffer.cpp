...
namespace tezcat::Tiny::GL
{
	...
	*/
	...
	void GLVertexBuffer::updateData(const void* data, size_t size)
	{
	...
	VertexBuffer* GLBufferCreator::createVertexBuffer()
	{
		return GLVertexBuffer::create();
	}

	Vertex* GLBufferCreator::createVertex()
	{
		return GLVertex::create();
	}

	IndexBuffer* GLBufferCreator::createIndexBuffer()
	{
