...
namespace tezcat::Tiny
{
	...
	*/
	...
	public:
		...
		virtual const TinyRTTI& RTTI() { return __TINY__RTTI__453; }
...
public:\
		...
		static const TinyRTTI* RTTIStatic() { return &__TINY__RTTI__453; }\
		virtual const TinyRTTI& RTTI() override { return __TINY__RTTI__453; }\
private:\
		static const TinyRTTI __TINY__RTTI__453;
...
visit:\
	...
	{\
		currentClass* obj = new currentClass(std::forward<Args>(args)...);\
		obj->autoGC();\
		obj->init();\
		return obj;\
	}\
